document.addEventListener("DOMContentLoaded", function () {
  ...
  introductoryMessage.innerHTML = `
      <div class="message" style>
        <img src="https://raw.githubusercontent.com/brainstationrandd/chatbot-widget/main/assets/chat_body2.svg" style="width: 60%; display: block; margin: 105px auto 35px;" alt="logo">
        <h3 class="chat__title" style="color: #302F2E; display: block; margin: 5px auto 0;  text-align: center;">Welcome to Sense Bot</h3>
        <p class="chat__title" style="background-color: #fff; color: #585979; display: block; margin: 0 auto 5px;  text-align: center;">Welcome to the Sense Bot! How can I help you??</p>
      </div>
    `;
...
const handleChat = (event) => {
  ...
  setTimeout(() => {
    generateResponse((decodedText) => {
      chatbox.appendChild(createChatLi(decodedText, "incoming"));
      chatbox.scrollTo(0, chatbox.scrollHeight);
    });
  }, 500);
